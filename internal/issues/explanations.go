...
var Explanations = map[string]IssueExplanation{
	...
	"og_title_too_long": {
		...
		Description: "The og:title value is longer than the recommended social preview length.",
		Impact:      "Long Open Graph titles are often truncated in social previews, reducing clarity and click-through.",
		Fix:         "Shorten og:title to roughly 90 characters or less while keeping the main message intact.",
	},
	"og_description_too_long": {
		Title:       "Open Graph Description Too Long",
		Description: "The og:description value is longer than the recommended social preview length.",
		Impact:      "Long Open Graph descriptions may be truncated or ignored by social platforms.",
		Fix:         "Shorten og:description to roughly 200 characters or less.",
	},
	"missing_og_url": {
		Title:       "Missing Open Graph URL",
		Description: "No og:url meta tag found.",
		Impact:      "Social platforms use og:url to consolidate shares and engagement signals for the canonical page.",
		Fix:         "Add <meta property=\"og:url\" content=\"...\"> pointing to the canonical absolute URL.",
	},
	"og_url_canonical_mismatch": {
		Title:       "Open Graph URL Canonical Mismatch",
		Description: "The og:url value differs from the page canonical URL.",
		Impact:      "Mismatch between social and canonical URLs can split share signals and create inconsistent previews.",
		Fix:         "Align og:url with the canonical URL unless there is a deliberate share-specific URL strategy.",
	},
	"missing_og_type": {
		Title:       "Missing Open Graph Type",
		Description: "No og:type meta tag found.",
		Impact:      "Social platforms use og:type to understand what kind of object is being shared.",
		Fix:         "Add <meta property=\"og:type\" content=\"website\"> or a more specific valid type.",
	},
	"missing_twitter_card": {
		Title:       "Missing Twitter Card Type",
		Description: "No twitter:card meta tag found.",
		Impact:      "Without a Twitter card type, X/Twitter previews may render with less predictable formatting.",
		Fix:         "Add <meta name=\"twitter:card\" content=\"summary_large_image\"> or another valid card type.",
	},
	"invalid_twitter_card_type": {
		Title:       "Invalid Twitter Card Type",
		Description: "The twitter:card value is not one of the supported card types.",
		Impact:      "Invalid card types may be ignored, producing a degraded or missing social preview.",
		Fix:         "Use summary, summary_large_image, app, or player as the twitter:card value.",
	},
	"missing_twitter_title": {
		Title:       "Missing Twitter Title",
		Description: "No Twitter-specific title is present and no Open Graph title is available as a fallback.",
		Impact:      "Twitter/X may generate a poor preview title from page content instead of a crafted social headline.",
		Fix:         "Add twitter:title or provide og:title as a fallback.",
	},
	"missing_twitter_image": {
		Title:       "Missing Twitter Image",
		Description: "No Twitter-specific image is present and no Open Graph image is available as a fallback.",
		Impact:      "Social posts without preview images tend to get lower engagement and look less polished.",
		Fix:         "Add twitter:image or provide og:image as a fallback.",
	},
