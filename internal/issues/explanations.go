...
var Explanations = map[string]IssueExplanation{
	...
	"og_title_too_long": {
		...
		Impact:      "Long Open Graph titles may be truncated in social previews, weakening the shared link's headline.",
		Fix:         "Shorten og:title to 90 characters or fewer while keeping the core message clear.",
	},
	"og_description_too_long": {
		...
		Impact:      "Long Open Graph descriptions are often truncated, reducing clarity and click-through from shared links.",
		Fix:         "Shorten og:description to 200 characters or fewer.",
	},
	"missing_og_url": {
		Title:       "Missing Open Graph URL",
		Description: "No og:url meta tag found.",
		Impact:      "Social platforms may canonicalize shares inconsistently without an explicit Open Graph URL.",
		Fix:         "Add <meta property=\"og:url\" content=\"...\"> pointing to the canonical page URL.",
	},
	"og_url_canonical_mismatch": {
		Title:       "Open Graph URL Mismatch",
		Description: "The og:url value differs from the page canonical URL.",
		Impact:      "Conflicting URL signals can split social engagement and search canonicalization hints across different URLs.",
		Fix:         "Align og:url with the canonical URL unless there is a deliberate sharing URL strategy.",
	},
	"missing_og_type": {
		Title:       "Missing Open Graph Type",
		Description: "No og:type meta tag found.",
		Impact:      "Social platforms use og:type to understand the content kind and render the preview appropriately.",
		Fix:         "Add <meta property=\"og:type\" content=\"website\"> or a more specific type such as article.",
	},
	"missing_twitter_card": {
		Title:       "Missing Twitter Card Type",
		Description: "No twitter:card meta tag found.",
		Impact:      "Without a Twitter Card type, X/Twitter may render a less engaging or incomplete link preview.",
		Fix:         "Add <meta name=\"twitter:card\" content=\"summary_large_image\"> or another supported card type.",
	},
	"invalid_twitter_card_type": {
		...
		Impact:      "Unsupported card types may be ignored, causing the shared link preview to render poorly.",
		Fix:         "Use one of: summary, summary_large_image, app, or player.",
	},
	"missing_twitter_title": {
		Title:       "Missing Twitter Title",
		Description: "No twitter:title or fallback og:title value found.",
		Impact:      "X/Twitter may generate a weak or generic title for shared links.",
		Fix:         "Add twitter:title or provide an og:title that can be used as a fallback.",
	},
	"missing_twitter_image": {
		Title:       "Missing Twitter Image",
		Description: "No twitter:image or fallback og:image value found.",
		Impact:      "Shared links without an image are less prominent and typically receive lower engagement.",
		Fix:         "Add twitter:image or provide an og:image that can be used as a fallback.",
	},
